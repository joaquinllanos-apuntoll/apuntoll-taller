...
const db = createClient({ url: rawUrl, authToken: rawToken });
...
async function initDB() {
  const tablas = [
    ...
    `CREATE TABLE IF NOT EXISTS ingresos (id TEXT PRIMARY KEY, taller_id TEXT NOT NULL, numero INTEGER DEFAULT 0, patente TEXT NOT NULL, fecha TEXT NOT NULL, marca TEXT DEFAULT '', modelo TEXT DEFAULT '', anio TEXT DEFAULT '', km INTEGER DEFAULT 0, cliente_id TEXT DEFAULT '', estado TEXT DEFAULT 'bueno', aceite TEXT DEFAULT 'ok', refrigerante TEXT DEFAULT 'ok', frenos TEXT DEFAULT 'ok', liq_frenos TEXT DEFAULT 'ok', trabajos TEXT NOT NULL, obs TEXT DEFAULT '', fotos TEXT DEFAULT '[]', created_at TEXT)`,
    `CREATE TABLE IF NOT EXISTS ordenes (id TEXT PRIMARY KEY, taller_id TEXT NOT NULL, numero INTEGER DEFAULT 0, patente TEXT NOT NULL, fecha TEXT NOT NULL, tecnico TEXT DEFAULT '', estado TEXT DEFAULT 'abierta', trabajos TEXT NOT NULL, items_mano_obra TEXT DEFAULT '[]', items_repuestos_taller TEXT DEFAULT '[]', items_repuestos_externos TEXT DEFAULT '[]', checklist TEXT DEFAULT '{}', km_egreso INTEGER DEFAULT 0, mano_obra REAL DEFAULT 0, costo_repuestos_taller REAL DEFAULT 0, costo_repuestos_externos REAL DEFAULT 0, total REAL DEFAULT 0, proximo_aceite INTEGER DEFAULT 0, aceite_usado TEXT DEFAULT '', obs TEXT DEFAULT '', created_at TEXT)`,
    `CREATE TABLE IF NOT EXISTS presupuestos (id TEXT PRIMARY KEY, taller_id TEXT NOT NULL, numero INTEGER DEFAULT 0, patente TEXT NOT NULL, fecha TEXT NOT NULL, fecha_caducidad TEXT DEFAULT '', cliente_id TEXT DEFAULT '', descripcion TEXT DEFAULT '', items TEXT DEFAULT '[]', total REAL DEFAULT 0, obs TEXT DEFAULT '', created_at TEXT)`,
    `CREATE TABLE IF NOT EXISTS movimientos (id TEXT PRIMARY KEY, taller_id TEXT NOT NULL, tipo TEXT NOT NULL, fecha TEXT NOT NULL, categoria TEXT DEFAULT 'otros', monto REAL NOT NULL, descripcion TEXT DEFAULT '', orden_id TEXT DEFAULT '', es_fijo INTEGER DEFAULT 0, created_at TEXT)`,
    `CREATE TABLE IF NOT EXISTS gastos_fijos (id TEXT PRIMARY KEY, taller_id TEXT NOT NULL, nombre TEXT NOT NULL, monto REAL NOT NULL, categoria TEXT DEFAULT 'otros', periodo_tipo TEXT DEFAULT 'mensual', periodo_valor INTEGER DEFAULT 1, proxima_fecha TEXT DEFAULT '', created_at TEXT)`,
    `CREATE TABLE IF NOT EXISTS movimientos_admin (id TEXT PRIMARY KEY, tipo TEXT NOT NULL, fecha TEXT NOT NULL, categoria TEXT DEFAULT 'suscripcion', monto REAL NOT NULL, descripcion TEXT DEFAULT '', taller_id TEXT DEFAULT '', created_at TEXT)`,
    `CREATE TABLE IF NOT EXISTS alertas (id TEXT PRIMARY KEY, taller_id TEXT NOT NULL, patente TEXT NOT NULL, telefono_dueno TEXT DEFAULT '', tipo TEXT DEFAULT 'fecha', fecha_alerta TEXT DEFAULT '', km_alerta INTEGER DEFAULT 0, aceite_usado TEXT DEFAULT '', filtros_cambiados TEXT DEFAULT '', notas TEXT DEFAULT '', resuelta INTEGER DEFAULT 0, created_at TEXT)`,
...
async function nextNum(tallerId, tipo) {
  ...
  if (!c) { await run('INSERT INTO contadores (id,taller_id,tipo,valor) VALUES (?,?,?,1)', [uuidv4(),tallerId,tipo]); return 1; }
